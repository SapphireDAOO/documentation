...
Deployed by [MasterDeployer](masterdeployer.sol.md#deploysystem) alongside the rest of the system, against the predicted `PaymentProcessorStorage` address; it only needs that address to know who its owner is.
